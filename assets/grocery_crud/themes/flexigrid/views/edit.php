<?php
	...
	$this->set_css(('css/estilo.css'));
	$this->set_js(('js/bootstrap.min.js'));
...
<?php 	if(!$this->unset_back_to_list) { ?>
		<div class='form-button-box'>
			<input type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>' id="save-and-go-back-button" class="btn btn-large btn-default"/>
		</div>
		<div class='form-button-box'>
